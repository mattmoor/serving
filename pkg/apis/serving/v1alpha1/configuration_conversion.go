...
func (source *ConfigurationSpec) ConvertUp(ctx context.Context, sink *v1beta1.ConfigurationSpec) error {
	if source.Build != nil {
		return ConvertErrorf("build",
			"build cannot be migrated forward, got: %#v", source.Build)
	}
	return source.RevisionTemplate.ConvertUp(ctx, &sink.Template)
}
...
func (sink *ConfigurationSpec) ConvertDown(ctx context.Context, source v1beta1.ConfigurationSpec) error {
	return sink.RevisionTemplate.ConvertDown(ctx, source.Template)
}
