...
func (source *TrafficTarget) ConvertUp(ctx context.Context, sink *v1beta1.TrafficTarget) {
	sink.Subroute = source.Name
	sink.RevisionName = source.RevisionName
	sink.ConfigurationName = source.ConfigurationName
	sink.Percent = source.Percent
	sink.URL = source.URL
}
